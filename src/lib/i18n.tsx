...
const copy = {
  en: {
    ...
    beforeTruckAlt: "Unbranded work truck before an MTD vehicle wrap",
    afterTruckAlt: "The same work truck after a custom MTD vehicle wrap",
  ...
  es: {
    ...
    beforeTruckAlt: "Camioneta de trabajo sin rotular antes de una rotulación de MTD",
    afterTruckAlt: "La misma camioneta de trabajo después de una rotulación personalizada de MTD",
