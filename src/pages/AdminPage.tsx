...
export default function AdminPage() {
  ...
  async function saveImage(id: string, patch: Partial<PortfolioImage>) {
    ...
    if (remoteReady) await fetch(`/api/admin/portfolio?id=${encodeURIComponent(id)}`, { method: "PATCH", headers: { "Content-Type": "application/json" }, body: JSON.stringify(patch) });
  }
