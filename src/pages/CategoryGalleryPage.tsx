    ...
    <main className="min-h-screen bg-ink px-5 py-8 sm:px-8 lg:py-12">
      <div className="mx-auto max-w-[1400px]">
        <div className="flex flex-wrap items-center justify-between gap-5 border-b border-line pb-6">
          <a href="/#work" className="inline-flex items-center gap-2 font-body text-sm font-bold uppercase tracking-wide text-bone transition-colors hover:text-orange"><ArrowLeft size={16} aria-hidden="true" /> {t("backToFeaturedWork")}</a>
        ...
        <header className="mt-14 max-w-3xl sm:mt-20">
          <p className="font-body text-xs font-bold uppercase tracking-[0.18em] text-orange">{t("featured")} {label}</p>
